...
<%
    ...
    String empty = "";
%>
<form class="box" action="AutoTopUpServlet" method="post" id="auto_top_up">
    <h1>Auto Top Up</h1>
    <h3>Top-Up when:</h3>
    <label for="when_zero">
        <input type="radio" id="when_zero" name="when" value="0" checked>
        $0
        <span></span>
    </label>
    <label for="when_ten">
        <input type="radio" id="when_ten" name="when" value="10">
        $10
        <span></span>
    </label>
    <label for="when_twenty">
        <input type="radio" id="when_twenty" name="when" value="20">
        $20
        <span></span>
    </label>
    <h3>Top-Up amount:</h3>
    ...
    <input type="submit" form="auto_top_up" name="confirm" value="Confirm">
