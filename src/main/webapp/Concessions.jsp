...
<p>never pay more than $<input type="number" name="daily_weekly_min" value=""> a day, $<input type="number" name="daily_weekly_max" value="50"> a week or $<input type="number" name="daily_weekly_weekends" value="8.15"> on Saturdays, Sundays and public holidays.</p>
